...
def main(callback=None):
    ...
    with open(real_path+'/model/keypoint_classifier/keypoint_classifier_label.csv',
    ...
    with open(
            real_path+'/model/point_history_classifier/point_history_classifier_label.csv',
            encoding='utf-8-sig') as f:
    ...
    while True:
        ...
        if results.multi_hand_landmarks is not None:
            for hand_landmarks, handedness in zip(results.multi_hand_landmarks,
                ...
                if callback:
                    callback(keypoint_classifier_labels[hand_sign_id])
                # yield (keypoint_classifier_labels[hand_sign_id])
        else:
            point_history.append([0, 0])
